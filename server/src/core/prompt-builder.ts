...
export function collectGitContext(projectRoot: string, target = "working-tree", ref?: string): string {
...
export function buildReviewPrompt(params: { projectRoot: string; target?: string; ref?: string; focus?: string; adversarial?: boolean; severityThreshold?: string }): string {
