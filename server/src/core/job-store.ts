...
export class JobStore {
  ...
  list(): JobState[] {
    if (!fs.existsSync(this.paths.jobsDir)) return [];
    return fs
      ...
      .filter(Boolean)
      .sort((a: JobState, b: JobState) => String(b.updatedAt).localeCompare(String(a.updatedAt)));
  }
